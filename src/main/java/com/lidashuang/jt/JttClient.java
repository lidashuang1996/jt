                    ...
                    public void initChannel(SocketChannel ch) throws Exception {
                        ...
                        pipeline.addLast(new ChannelInboundHandler() {
                            ...
                            public void channelActive(ChannelHandlerContext channelHandlerContext) throws Exception {
                                ...
                                byte[] bytes = new byte[] {
                                        //
                                        126, 2, 0, 0, 37, 39, 32, 22, 99, 64, 35, 36, 33, 0, 4, 0, 4, 0, 4, 0, 1, 1, 88, 77, -100, 6, -55, 101, 20, 0, 2, 0, 0, 0, 0, 33, 4, 40, 20, 54, 34, 1, 4, 0, 0, 4, 67, 49, 1, 0, 125, 1, 126
                                        // 126, 1, 2, 0, 17, 39, 32, 22, 99, 64, 35, 9, 44, 67, 56, 48, 53, 54, 48, 67, 65, 50, 48, 68, 51, 52, 68, 70, 69, 0, 90, 126
                                        // 126, 1, 2, 0, 17, 39, 32, 22, 99, 64, 35, 8, 127, 51, 52, 51, 55, 48, 68, 56, 56, 55, 66, 68, 55, 52, 57, 52, 66, 0, 125, 2, 126
